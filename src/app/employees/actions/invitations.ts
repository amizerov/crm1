      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <p>Здравствуйте!</p>
              <p><strong>${inviterName}</strong> приглашает вас стать <strong>${roleText}</strong> компании <strong>${companyName}</strong> в системе TMS, RCC.</p>
              ...
              <p>Если у вас ещё нет аккаунта в TMS, RCC, вы сможете зарегистрироваться при принятии приглашения.</p>
...
${inviterName} приглашает вас стать ${roleText} компании ${companyName} в системе TMS, RCC.
...
Если у вас ещё нет аккаунта в TMS, RCC, вы сможете зарегистрироваться при принятии приглашения.
